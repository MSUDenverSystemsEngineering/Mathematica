...
function Install-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath "setup.exe" -ArgumentList "/verysilent /norestart" -IgnoreExitCode "3010"
    ...
    Copy-ADTFile -Path "$($adtSession.DirFiles)\mathpass" -Destination "C:\ProgramData\Mathematica\Licensing"
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath "C:\Program Files\Wolfram Research\Wolfram\14.2\SystemFiles\UninstallFiles\Windows\unins000.exe" -ArgumentList "/verysilent"
    ## Uninstall Wolfram Script 
    Start-ADTMsiProcess -Action "Uninstall" -ProductCode "{46F1547C-FBB4-11EF-86FE-00155D55CBDB}"
    ##================================================
    ...
    ## Remove Wolfram Research directories.
    Remove-ADTFolder -Path "C:\Program Files\Wolfram Research"
}
